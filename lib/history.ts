...
export type HistoryEvent = {
  ...
  cite: string;
  flag?: string;
  key?: boolean; // shown in the horizontal key-milestone ribbon
};
...
export const HISTORY_EVENTS: HistoryEvent[] = [
  { era: "e1", year: "1892", title: "A filterable agent", key: true,
  ...
  { era: "e1", year: "1898", title: "The virus concept", key: true,
  ...
  { era: "e2", year: "1917", title: "The bacteriophage", key: true,
  ...
  { era: "e3", year: "1952", title: "DNA is the genes", key: true,
  ...
  { era: "e3", year: "1971", title: "The Baltimore scheme", key: true,
  ...
  { era: "e3", year: "1977", title: "phiX174 and Sanger", key: true,
  ...
  { era: "e4", year: "1989", title: "The ocean is full of viruses", key: true,
  ...
  { era: "e4", year: "2003", title: "The human gut virome", key: true,
  ...
  { era: "e5", year: "2014", title: "crAssphage", key: true,
  ...
  { era: "e5", year: "2020", title: "A taxonomy of realms", key: true,
  ...
  { era: "e5", year: "2022-24", title: "The Human Virome Program", key: true,
